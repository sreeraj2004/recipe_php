...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($imgId == 'one') {
        ...
        Roll out one portion on a floured surface to your desired thickness (about 12 inches in diameter).
        ...
        Distribute half of the chicken mixture and any additional toppings evenly over the cheese. Sprinkle with dried oregano if desired.

        Bake the Pizza:
        Carefully transfer the pizza (with parchment paper) to the preheated stone or baking sheet.
        Bake for about 12-15 minutes, or until the crust is golden and the cheese is bubbly.
        Repeat with the second dough portion and toppings.

        Serve:
        Once baked, remove the pizza from the oven and let it cool slightly.
        Garnish with fresh basil leaves, slice, and enjoy your delicious chicken pizza!
        ";
    } 
    else if($imgid == 'five'){
    ...
    $headers = "From: sreerajmutha@gmail.com" . "\r\n" .
               "Reply-To: Sreerajmutha@gmail.com" . "\r\n" .
